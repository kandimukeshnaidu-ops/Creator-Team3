          ...
          {chartData.length > 0 && (
            <div className="revenue-chart-card">
              <div className="chart-header">
                <h4 className="chart-title">Monthly Revenue Trends</h4>
              </div>
              <div style={{ width: '100%', height: 300 }}>
                <ResponsiveContainer>
                  <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                    ...
                    />
                    <Area type="monotone" dataKey="earnings" stroke="var(--accent-primary)" strokeWidth={3} fillOpacity={1} fill="url(#revenueGlow)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>

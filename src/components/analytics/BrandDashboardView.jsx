...
export default function BrandDashboardView() {
  const [campaigns, setCampaigns] = useState([
    { id: 1, name: "Summer Product Launch", creators: 24, reach: "2.4M", engagement: "8.7%", status: "Active" },
    { id: 2, name: "Influencer Awareness", creators: 18, reach: "1.8M", engagement: "7.2%", status: "Active" },
    { id: 3, name: "New Product Campaign", creators: 12, reach: "950K", engagement: "5.8%", status: "Completed" }
  ]);
